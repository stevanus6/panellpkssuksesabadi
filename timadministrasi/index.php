...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Include Sidebar -->
        <?php
        // Determine the path to the sidebar based on the current script
        $sidebarPath = str_contains($_SERVER['SCRIPT_NAME'], 'index.php') ? './layout/sidebar.php' : '../layout/sidebar.php';
        include $sidebarPath;
        ?>
